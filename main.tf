...
module "vpc" {
  source = "github.com/Kristin0/terraform-modules/tree/main/aws_network"
  instance_id = module.server.ec2_instance_id
}

module "database" {
  source = "github.com/Kristin0/terraform-modules/tree/main/aws_database"
...
module "server" {
  source = "github.com/Kristin0/terraform-modules/tree/main/aws_server"
  security_group_id = module.vpc.http_security_group_id
